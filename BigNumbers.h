...
public:
     ...
     * Multiply the current instance by another BigNumber
     * @param other - The other BigNumber
     * @return The Karatsuban product of the two BigNumbers
     */
    BigNumber karatsuba_multiply(const BigNumber& other) const;
     ...
     * @return The Karatsuban product of the two BigNumbers
     */
    BigNumber toomCook3Multiply(const BigNumber& other) const;

    BigNumber ToomCook5_multiply(const BigNumber& other) const;

    bool Solovay_Strassen(int iterations = 10) const;

    bool Rabin_Miller(int iterations = 10) const;

    bool Luke_Lemer() const;
     ...
     * Modulus operator
     * @param b1 - The current instance
     * @param b2 - The number being divided by with remainder
     * @return The quotient of the two numbers
     */
    friend BigNumber operator%(BigNumber b1, const BigNumber& b2);
    friend BigNumber operator%(BigNumber b1, const long long& b2);
